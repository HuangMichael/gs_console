...
public class ConstantUtils {
    ...
    public static final String STATUS_AUTHORIZED = "已审核"; //状态"已审核" 表示数据通过审核，可显示在前台。"未审核"则不显示在前台
    public static final String STATUS_NOT_AUTHORIZED = "未审核"; //状态"已审核" 表示数据通过审核，可显示在前台。"未审核"则不显示在前台
}
